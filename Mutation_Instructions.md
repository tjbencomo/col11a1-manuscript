...
Mutations from the 100 SCC can be found in Table S2. These mutations come from multiple cohorts. 
The following instructions are how to generate the mutation table from scratch.
